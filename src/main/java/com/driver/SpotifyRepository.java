...
public class SpotifyRepository {
    ...
    public Album createAlbum(String title, String artistName) {
        ...
        if(Nartist==null){
            Nartist = createArtist(artistName);
            ...
            List<Album> l1 = new ArrayList<>();
            l1.add(album);
            artistAlbumMap.put(Nartist,l1);
            ...
            List<Album> l1 = artistAlbumMap.get(Nartist);
            if(l1 == null){
                l1= new ArrayList<>();
            }
            l1.add(album);
    ...
    public Song createSong(String title, String albumName, int length) throws Exception{
        Album album = null;
        for(Album Nalbum:albums){
            if(Nalbum.getTitle()==albumName){
                album=Nalbum;
                break;
            }
        }
        if(album==null)
            ...
            if(albumSongMap.containsKey(album)){
                List<Song> l1 = albumSongMap.get(album);
                l1.add(song);
                albumSongMap.put(album,l1);
            }else{
